...
struct llama_context {
    ...
    float * get_embeddings_layer_inp_ith(uint32_t lid, int32_t i);
    ...
    void state_write(llama_io_write_i & writer, const llama_token * tokens, size_t n_tokens) const;
    bool state_read(llama_io_read_i & reader, llama_token * tokens_out, size_t n_tokens_max, size_t * n_tokens_out);
